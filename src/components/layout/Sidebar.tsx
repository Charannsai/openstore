...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-4 top-4 bottom-4 w-[240px] z-40 select-none">
      ...
      <div className="w-full h-full crazy-sidebar rounded-[24px] flex flex-col justify-between p-3.5 relative overflow-hidden transition-all duration-200 bg-white dark:bg-[#121215] border border-zinc-200 dark:border-white/10 shadow-lg dark:shadow-2xl">
